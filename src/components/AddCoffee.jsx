...
const AddCoffee = () => {
    ...
    return (
        <div className='py-12 md:px-28'>
            <Link to="/"><p className='rancho-regular text-xl my-3 flex gap-2 items-center hover:bg-[#D2B48C] hover:text-white cursor-pointer px-5 py-2 rounded-xl w-fit'> <ArrowLeft /> Back to Home</p></Link>
